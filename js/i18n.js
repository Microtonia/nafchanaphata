...
<p>选中多个音符后，用维度快捷键或弹窗里的维度按钮 — 批量给每个选中音符添加维度</p>
<h4>自定义维度（Config）</h4>
...
<p>谱线 0d~4d — 勾选显示对应维度谱线；0d 为基准线（默认勾选，取消后基准线消失）</p>
<p>分割谱线 — 默认勾选；按分辨率细分拍内竖线，取消后任何竖谱线都不显示</p>
<p>时值相同 — 默认勾选；点击创建音符时值自动匹配分辨率</p>
<p>音色 — 含采样音源与实时合成音源（正弦波 / 方波 / 锯齿波 / 三角波）</p>
<p>卷帘式播放 — MIDI 风格滚屏</p>
